...
export const DAILY_QUEST_POOL = [
  ...
  { id: 'dq_log_water',     label: 'Hit your water goal',                xp: 50,  type: 'hit_water' },
  ...
  { id: 'dq_run',           label: 'Go for a run',                       xp: 150, type: 'run' },
  { id: 'dq_swim',          label: 'Hit the pool today',                 xp: 200, type: 'swim' },
  { id: 'dq_bike',          label: 'Log a bike ride',                    xp: 120, type: 'bike' },
  { id: 'dq_yoga',          label: 'Do a yoga session',                  xp: 80,  type: 'yoga' },
  { id: 'dq_any_workout',   label: 'Log any workout today',              xp: 80,  type: 'any_workout' },
  { id: 'dq_two_workouts',  label: 'Log two workouts today',             xp: 150, type: 'two_workouts' },
  { id: 'dq_log_all',       label: 'Log weight, water, and calories',    xp: 120, type: 'log_all' },
  { id: 'dq_weight_cals',   label: 'Log both weight and calories',       xp: 80,  type: 'weight_and_cals' },
  { id: 'dq_big_water',     label: 'Drink 80+ oz of water today',        xp: 75,  type: 'big_water' },
];

export const WEEKLY_QUEST_POOL = [
  { id: 'wq_log5',       label: 'Log your weight 5 days this week',        xp: 300, target: 5, type: 'weight_logs' },
  { id: 'wq_log7',       label: 'Log your weight every day this week',     xp: 500, target: 7, type: 'weight_logs' },
  { id: 'wq_water3',     label: 'Hit water goal 3 days this week',         xp: 200, target: 3, type: 'water_hits' },
  { id: 'wq_water7',     label: 'Hit your water goal every day this week', xp: 500, target: 7, type: 'water_hits' },
  { id: 'wq_gym1',       label: 'Get to the gym at least once',            xp: 350, target: 1, type: 'gym_visits' },
  { id: 'wq_gym2',       label: 'Hit the gym twice this week',             xp: 600, target: 2, type: 'gym_visits' },
  { id: 'wq_walk5',      label: 'Log 5 walks this week',                   xp: 250, target: 5, type: 'walk_logs' },
  { id: 'wq_run2',       label: 'Log 2 runs this week',                    xp: 300, target: 2, type: 'run_logs' },
  { id: 'wq_swim1',      label: 'Hit the pool at least once this week',    xp: 250, target: 1, type: 'swim_logs' },
  { id: 'wq_yoga2',      label: 'Do yoga twice this week',                 xp: 150, target: 2, type: 'yoga_logs' },
  { id: 'wq_any5',       label: 'Log any workout 5 times this week',       xp: 400, target: 5, type: 'any_workout_logs' },
  { id: 'wq_variety',    label: 'Log 3 different workout types this week', xp: 350, target: 3, type: 'workout_variety' },
